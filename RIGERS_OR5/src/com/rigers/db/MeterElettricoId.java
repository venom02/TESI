...
/**
 * MeterElettricoId generated by hbm2java
 */
public class MeterElettricoId implements java.io.Serializable {

	private Date dataLettura;
	private int idDispositivo;
	private int idEdificio;

	public MeterElettricoId() {
	}

	public MeterElettricoId(Date dataLettura, int idDispositivo, int idEdificio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MeterElettricoId))
			return false;
		MeterElettricoId castOther = (MeterElettricoId) other;
