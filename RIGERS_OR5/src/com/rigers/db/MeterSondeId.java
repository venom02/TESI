...
/**
 * MeterSondeId generated by hbm2java
 */
public class MeterSondeId implements java.io.Serializable {
	...
	public MeterSondeId(Date dataLettura, int idDispositivo, int idEdificio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MeterSondeId))
			return false;
		MeterSondeId castOther = (MeterSondeId) other;
