...
/**
 * IlluminazionePubId generated by hbm2java
 */
public class IlluminazionePubId implements java.io.Serializable {

	private int idDispositivoPub;
	private int idCompartimento;

	public IlluminazionePubId() {
	}

	public IlluminazionePubId(int idDispositivoPub, int idCompartimento) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IlluminazionePubId))
			return false;
		IlluminazionePubId castOther = (IlluminazionePubId) other;
